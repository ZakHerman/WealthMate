...
namespace WealthMate
{
    public partial class App
    {
        ...
        public void InitializeDummyUserPortfolio()
        {
            ...
            User.Portfolio.OwnedAssets.Add(new OwnedStock(new Stock{CompanyName = "Burger Fuel", CurrentPrice = 42.2f, LastTrade = new DateTime(2019, 09, 09, 0, 0, 0), Shares = 4, Volume = 4}, new System.DateTime(2019, 09, 09, 0, 0, 0), 50.0f, 100, 1000f));
            User.Portfolio.OwnedAssets.Add(new OwnedStock(new Stock { CompanyName = "Spark", CurrentPrice = 3.24f, LastTrade = new DateTime(2019, 09, 09, 0, 0, 0), Shares = 4, Volume = 4 }, new System.DateTime(2019, 09, 09, 0, 0, 0), 3.00f, 150, 500f));
